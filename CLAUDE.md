...
- Agent data stored in `.agents/<id>/` (meta.json, prompt.txt, start.sh, repo/)
...
| 765 | `read` | Read agent's tmux output |
| 856 | `status` | Show agent's git commits/changes |
| 983 | `diff` | Show full diff of agent's work |
| 1071 | `kill` | Stop agent, optionally cleanup |
| 1184 | `merge` | Merge agent's branch into main |
